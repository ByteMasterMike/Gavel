  ...
  try {
    const ruling = await prisma.userRuling.create({
      data: {
        ...
        flaggedDocIds: parsed.flaggedDocIds as Prisma.InputJsonValue,
        starredDocIds: parsed.starredDocIds as Prisma.InputJsonValue,
        citedPrecedentIds: parsed.citedPrecedentIds as Prisma.InputJsonValue,
        openedDocIds: parsed.openedDocIds as Prisma.InputJsonValue,
